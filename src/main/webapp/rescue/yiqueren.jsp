...
<div class="main">
 ...
 <div id="maintabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
	<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all" role="tablist">
				...
				<li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active" role="tab" tabindex="-1" aria-controls="ui-tabs-2" aria-labelledby="ui-id-2" aria-selected="true"><a href="../rescue/getStatusMess?status=yiqueren" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-2">申请已确认</a></li>
...
<table class="titem">
	<tbody><tr>
		...
		<td class="value" style="text-align:left;">
			<input type="hidden" name="type" value="yiqueren">
		...
		<div class="mainbox" style="overflow-x: scroll;">
			...
			<form name="myform" method="post" action="../rescue/multiDel">
				<div class="option_bar">
					...
					<input type="hidden" name="flag" value="yiqueren">
							...
							<tr>
								...
								<td class="option">
									<c:if test="${rescue.status=='申请已确认'}">
										...
										<a class="del" href="../rescue/del?rescueId=${rescue.id}&flag=yiqueren" title="删除"><span class="ui-icon ui-icon-trash" style="float: left;"></span></a>
									</c:if>
								</td>
								<td>${rescue.status}</td>
