...
<div class="main">
 ...
 <div id="maintabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
	<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all" role="tablist">
				...
				<li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active"" role="tab" tabindex="-1" aria-controls="ui-tabs-3" aria-labelledby="ui-id-3" aria-selected="false"><a href="../rescue/getStatusMess?status=yipaichu" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-3">车辆已派出</a></li>
				<li class="ui-state-default ui-corner-top" role="tab" tabindex="-1" aria-controls="ui-tabs-4" aria-labelledby="ui-id-4" aria-selected="true"><a href="../rescue/getStatusMess?status=yijieshu" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-4">救援已结束</a></li>
...
<table class="titem">
	<tbody><tr>
		...
		<td class="value" style="text-align:left;">
			<input type="hidden" name="type" value="yipaichu">
...
<br>
		...
		<div class="mainbox" style="overflow-x: scroll;">
			...
			<form name="myform" method="post" action="http://liwei-pc:8010/rescue/delmulti">
