...
<div id="maintabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
	<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all" role="tablist">
		<li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active" role="tab" tabindex="0" aria-controls="ui-tabs-1" aria-labelledby="ui-id-1" aria-selected="true"><a href="../rescue/getAllMess" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-1">全部信息</a></li>
				<li class="ui-state-default ui-corner-top" role="tab" tabindex="-1" aria-controls="ui-tabs-2" aria-labelledby="ui-id-2" aria-selected="false"><a href="../rescue/getStatusMess?status=yiqueren" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-2">申请已确认</a></li>
				...
				<li class="ui-state-default ui-corner-top" role="tab" tabindex="-1" aria-controls="ui-tabs-4" aria-labelledby="ui-id-4" aria-selected="false"><a href="../rescue/getStatusMess?status=yijieshu" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-4">救援已结束</a></li>
	</ul><div id="ui-tabs-1" class="ui-tabs-panel ui-widget-content ui-corner-bottom" aria-live="polite" aria-labelledby="ui-id-1" role="tabpanel" aria-expanded="true" aria-hidden="false">	
...
<table class="titem">
	<tbody><tr>
		...
		<td class="value" style="text-align:left;">
			<input type="hidden" name="type" value="listAll">
		...
		<div class="mainbox" style="overflow-x: scroll;">
			...
			<form name="myform" method="post" action="../rescue/multiDel">
				<div class="option_bar">
					...
					<input type="hidden" name="status" value="listAll">
				</div>
					...
					<c:if test="${!empty rescues}">
						<c:forEach items="${rescues}" var="rescue">
							<tr>
								...
								<td align="center">
									<input type="checkbox" value="${rescue.id}" class="itemid" name="ids" id="ids">
								</td> 
								</c:if>
								...
								<td class="option">
									<c:if test="${rescue.status=='申请已确认'}">
										...
										<a class="del" href="../rescue/del?rescueId=${rescue.id}&flag=listAll" title="删除"><span class="ui-icon ui-icon-trash" style="float: left;"></span></a>
									</c:if>
									<c:if test="${rescue.status=='车辆已派出'}">
